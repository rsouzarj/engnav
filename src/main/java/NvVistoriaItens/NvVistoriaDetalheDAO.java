...
/*     */ public class NvVistoriaDetalheDAO
/*     */ {
/*     */   public NvVistoriaDetalheVa inserir(NvVistoriaDetalheVa nvCertificadoDetalhe)
/*     */   {
/*     */     try
/*     */     {
...
/*  69 */       Logger.getLogger(NvVistoriaDetalheDAO.class.getName()).log(Level.SEVERE, null, ex);
...
/*     */     }
/*     */     catch (SQLException ex) {
/* 115 */       Logger.getLogger(NvVistoriaDetalheDAO.class.getName()).log(Level.SEVERE, null, ex);
...
/*     */   }
/*     */   /*     */   /*     */   /*     */   
/*     */   public List<NvVistoriaDetalheVa> listar(ClausulaWhere sClausula) {
/*     */     try {
...
/*     */       
/* 129 */       List<NvVistoriaDetalheVa> listaNvCertificadoDetalhe = new ArrayList();
/* 130 */       PreparedStatement ps = conn.prepareStatement(sql);
/* 131 */       ResultSet rs = ps.executeQuery();
/*     */       
/* 133 */       while (rs.next()) {
/* 134 */         NvVistoriaDetalheVa nvCertificadoDetalhe = new NvVistoriaDetalheVa();
...
/*     */     } catch (SQLException ex) {
/* 154 */       Logger.getLogger(NvVistoriaDetalheDAO.class.getName()).log(Level.SEVERE, null, ex);
/* 155 */       System.out.println(ex.getMessage()); }
/* 156 */     return null;
/*     */   }

/*     */   public List<NvVistoriaDetalheVa> listarE(ClausulaWhere sClausula) {
/*     */     try {
/* 124 */       Conexao conexao = new Conexao();
/* 125 */       Connection conn = Conexao.getConnection();
...
/*     */   
/*     */   public boolean deletar(NvVistoriaDetalheVa nvCertificadoDetalhe)
/*     */   {
/*     */     try {
